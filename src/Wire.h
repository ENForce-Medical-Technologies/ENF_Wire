...
public:
    ...
    esp_err_t requestFrom(uint16_t address, size_t size, bool sendStop);
    esp_err_t requestFrom(uint16_t address, uint8_t size, bool sendStop);
    esp_err_t requestFrom(uint16_t address, uint8_t size, uint8_t sendStop);
    esp_err_t requestFrom(uint8_t address, size_t len, bool stopBit);
    esp_err_t requestFrom(uint16_t address, uint8_t size);
    esp_err_t requestFrom(uint8_t address, uint8_t size, uint8_t sendStop);
    esp_err_t requestFrom(uint8_t address, uint8_t size);
    esp_err_t requestFrom(int address, int size, int sendStop);
    esp_err_t requestFrom(int address, int size);
